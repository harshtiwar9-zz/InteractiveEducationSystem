...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="brand-logo center-align">
        ...
        <asp:SqlDataSource ID="profilesource" runat="server" ConnectionString="Data Source=Harsh-HP;Initial Catalog=IES;Integrated Security=True" DeleteCommand="DELETE FROM [Student] WHERE [Student_Id] = @Student_Id" InsertCommand="INSERT INTO [Student] ([Last_name], [First_name], [Gender], [Program_Code_FK], [ID_FK]) VALUES (@Last_name, @First_name, @Gender, @Program_Code_FK, @ID_FK)" ProviderName="System.Data.SqlClient" SelectCommand="SELECT [Student_Id], [Last_name], [First_name], [Gender], [Program_Code_FK], [ID_FK] FROM [Student] WHERE ([ID_FK] = @ID_FK)" UpdateCommand="UPDATE [Student] SET [Last_name] = @Last_name, [First_name] = @First_name, [Gender] = @Gender, [Program_Code_FK] = @Program_Code_FK, [ID_FK] = @ID_FK WHERE [Student_Id] = @Student_Id">
            <DeleteParameters>
